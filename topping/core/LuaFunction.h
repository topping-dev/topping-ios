...
#define ClassMethod(SEL, RET, ARGS, KEY) [dict setObject:[LuaFunction Create:class_getClassMethod([self class], @selector(SEL)) :@selector(SEL) :[RET class] :ARGS] forKey:KEY];
...
#define ClassMethodNoRet(SEL, ARGS, KEY) [dict setObject:[LuaFunction Create:class_getClassMethod([self class], @selector(SEL)) :@selector(SEL) :nil :ARGS] forKey:KEY];
...
#define ClassMethodNoArg(SEL, RET, KEY) [dict setObject:[LuaFunction Create:class_getClassMethod([self class], @selector(SEL)) :@selector(SEL) :[RET class] :[[NSArray alloc] initWithObjects:nil]] forKey:KEY];
...
#define ClassMethodNoRetNoArg(SEL, KEY) [dict setObject:[LuaFunction Create:class_getClassMethod([self class], @selector(SEL)) :@selector(SEL) :nil :[[NSArray alloc] initWithObjects:nil] forKey:KEY];
