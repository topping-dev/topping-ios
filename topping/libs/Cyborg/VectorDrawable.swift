...
@objc(AndroidTint)
public class AndroidTint : NSObject {
    public init(blendMode: BlendMode, color: UIColor) {
...
@objc(BlendMode)
public class BlendMode: NSObject, XMLStringRepresentable {
    ...
    public static let add = BlendMode(rawValue: "add")
    public static let clear = BlendMode(rawValue: "clear")
    public static let darken = BlendMode(rawValue: "darken")
    public static let dst = BlendMode(rawValue: "dst")
    public static let dstAtop = BlendMode(rawValue: "dstAtop")
    public static let dstIn = BlendMode(rawValue: "dstIn")
    public static let dstOut = BlendMode(rawValue: "dstOut")
    public static let dstOver = BlendMode(rawValue: "dstOver")
    public static let lighten = BlendMode(rawValue: "lighten")
    public static let multiply = BlendMode(rawValue: "multiply")
    public static let overlay = BlendMode(rawValue: "overlay")
    public static let screen = BlendMode(rawValue: "screen")
    public static let src = BlendMode(rawValue: "src")
    public static let srcAtop = BlendMode(rawValue: "srcAtop")
    public static let srcIn = BlendMode(rawValue: "srcIn")
    public static let srcOut = BlendMode(rawValue: "srcOut")
    public static let srcOver = BlendMode(rawValue: "srcOver")
    public static let xor = BlendMode(rawValue: "xor")
}
...
@objc(GroupChild)
public protocol GroupChild: AnyObject {
    
    func createLayers(externalValues: ExternalValues,
                      drawableSize: CGSize,
                      transform: [Transform],
...
@objc(VectorDrawable)
public class VectorDrawable : NSObject {

    /// The intrinsic width in points.
    @objc public let baseWidth: CGFloat

    /// The intrinsic height in points.
    @objc public let baseHeight: CGFloat
    ...
    @objc public let viewPortWidth: CGFloat
    ...
    @objc public let viewPortHeight: CGFloat

    /// The overall alpha to apply to the drawable.
    @objc public let baseAlpha: CGFloat
    
    /// Whether the Drawable flips automatically in RTL.
    @objc public let autoMirrored: Bool
    ...
    @objc public let tint: AndroidTint?
    ...
    public class Group: GroupChild {
        ...
        public func createLayers(externalValues: ExternalValues,
                          drawableSize: CGSize,
                          transform: [Transform],
                          tint: AndroidTint) -> [CALayer] {
            ...
            let pathLayers = Array(
                children.map { child in
                    child.createLayers(externalValues: externalValues,
...
extension UIColor {
    ...
    func tintedWith(_ tint: AndroidTint) -> UIColor {
        return tint.blendMode.blend(src: self, dst: tint.color)
    }
