...
final class DialogPresentationController: UIPresentationController {
    ...
    private var backdropView: UIView = UIView()
    ...
    override func presentationTransitionWillBegin() {
        ...
        let flBackDrop = LGFrameLayout.create(presentedView.wrapper.lc)
        flBackDrop!.android_layout_width = "match_parent"
        flBackDrop!.android_layout_height = "match_parent"
        flBackDrop!.fullInit()
        backdropView = flBackDrop!._view
        backdropView.backgroundColor = dialogBackdropColor
        backdropView.alpha = 0

        containerView.addSubview(flBackDrop!._view)
        ...
        flBackDrop!.addSubview(presentedView.wrapper)
        flBackDrop!.componentAddMethod(flBackDrop?._view, presentedView)
        flBackDrop!.resize()
...
final class ConstraintDialogPresentationController: UIPresentationController {
